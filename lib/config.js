...
const SMTP_TRANSPORT = {
  ...
  port: 587,
  auth: {
    user: 'movejayoose@gmail.com',
    pass: 'Bluejayshuttlesucks' // create a Gmail app password here: https://security.google.com/settings/security/apppasswords
  },
...
module.exports = {
  ...
  mailOptions: {
    from: '"Movejay" <movejayoose@gmail.com>',
  },
  debugEnabled: false
};
